# Data Science Course 4 - Eploratory Data Analysis - Assigntment 1.2: plot2.R and plot2.png
# Pre-steps: 
...
plot(PC3$timestamp, PC3$Global_active_power, type = "l", xlab="", ylab="Global Active Power (kilowatts)")
